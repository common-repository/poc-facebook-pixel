...
Tags: pixel, facebook, graph, woocommerce, post, wp ecommerce, jigoshop, buddypress, bbpress
Requires at least: 3.8
Tested up to: 3.9.2
Stable tag: 1.0.1
License: GPLv2 or later
License URI: http://www.gnu.org/licenses/gpl-2.0.html
Donate link: https://github.com/PinchOfCode/poc-facebook-pixel/

Adds Facebook pixel code in all your post types conditionally.
...
1. The list of custom pixel codes.
2. Adding a custom pixel code.
